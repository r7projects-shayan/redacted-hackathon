    ...
    return (
        <>
            <div className="grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1 sm:grid-cols-1 grid-flow-row home justify-items-center align-items-center p-10 " id="home">
                <div className="mx-10 ">
                    <h2 className="lg:text-8xl space-x-4 mb-4 sm:text-5xl text-5xl md:text-5xl">Revolutionizing Information Accessibility .</h2>
                ...
                <div className=" d-flex justify-content-center sm:w-100 w-100 md:w-100" style={{width : "700px",  padding :"10px"}}>
